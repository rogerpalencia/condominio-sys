                        ...
                        <a href="#!" class="text-reset notification-item">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <img src="assets/images/users/user.png" class="rounded-circle avatar-sm"
                                        alt="user-pic">
                                </div>
                                <div class="flex-grow-1">
                                    ...
                                    <div class="font-size-13 text-muted">
                                        ...
                                        <p class="mb-0"><i class="mdi mdi-clock-outline"></i>
                                            <span><?php echo $language["1_hours_ago"]; ?></span></p>
                                    </div>
                                </div>
                            </div>
                        </a>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="font-size-13 text-muted">
                                        ...
                                        <p class="mb-0"><i class="mdi mdi-clock-outline"></i>
                                            <span><?php echo $language["3_min_ago"]; ?></span></p>
                                    </div>
                                </div>
                            </div>
                        </a>
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <?php
                    if ($userid == 45)  {
                        $sql = "SELECT DISTINCT p.id_programa as codigo,p.grupo as grupo, p.nombre as nombre, p.accion as accion, 
                        orden, dp.id_perfil 
                        from detalles_perfiles dp, programas p where dp.id_perfil =11 and grupo=2";

                    } else {
                        $sql = "SELECT DISTINCT p.id_programa as codigo,p.grupo as grupo, p.nombre as nombre, p.accion as accion, orden
                    FROM programas p INNER join detalles_perfiles dp ON p.id_programa = dp.id_programa
                    WHERE dp.id_perfil = $userid and p.grupo=2 ORDER BY orden, codigo, nombre "; // GRUPO ADUANA
                ...
                <li>
                    ...
                    $sql = "SELECT DISTINCT p.id_programa as codigo,p.grupo as grupo, p.nombre as nombre, p.accion as accion, orden
                    FROM programas p INNER join detalles_perfiles dp ON p.id_programa = dp.id_programa
                    WHERE dp.id_perfil = $userid and p.grupo=3 ORDER BY orden, codigo, nombre "; // GRUPO ADUANA
                    $rs = $conn->query($sql);
                    if (empty($rs)) {
                    } else {
                        echo '<a href="javascript: void(0);" class="has-arrow">
...
if ($userid == 45) {
    ...
    from detalles_perfiles dp, programas p where dp.id_perfil =11 and grupo=2";
                    ...
                    $sql = "SELECT DISTINCT p.id_programa as codigo,p.grupo as grupo, p.nombre as nombre, p.accion as accion, orden
                    FROM programas p INNER join detalles_perfiles dp ON p.id_programa = dp.id_programa
                    WHERE dp.id_perfil = $userid and p.grupo=4 ORDER BY orden, codigo, nombre "; // GRUPO ADUANA
                ...
                <li>
                    ...
                    $sql = "SELECT DISTINCT p.id_programa as codigo,p.grupo as grupo, p.nombre as nombre, p.accion as accion, orden
                    FROM programas p INNER join detalles_perfiles dp ON p.id_programa = dp.id_programa
                    WHERE dp.id_perfil = $userid and p.grupo=5   ORDER BY p.orden"; // GRUPO ADUANA
                    $rs = $conn->query($sql);
                    if (empty($rs)) {  } else {
                        //echo $sql;
                        echo  ' <a href="javascript: void(0);" class="has-arrow"> 
                ...
                <li>
                            ...
                            <a href="logout.php" data-key="t-lock-screen" data-key="t-register">
                                ...
                                <span data-key="t-pages">Salir del Sistema</span>
                            </a>
                </li>
