...
WHERE
date( declaraciones_aduana.fecha_declaracion) = date(now())  and id_estatus>0 
GROUP BY
...
<script>
    ...
    chart1.updateOptions({
        title: { text: 'Declaraciones Aduanales en cola, hoy ' + fecha_hoy },
    });
</script>


<div class="card-body">
<input type="hidden" name="fecha_hoy" id="fecha_hoy" value="<?php echo $fecha_hoy?> ">
