...
WHERE
EXTRACT(MONTH FROM declaraciones_aduana.fecha_declaracion) = $mes_actual   and id_estatus>0 and
EXTRACT(YEAR FROM declaraciones_aduana.fecha_declaracion) = $anio_actual  
GROUP BY
