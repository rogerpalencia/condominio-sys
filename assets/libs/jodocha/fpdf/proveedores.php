...
while ($contador < mysql_num_rows($res_resultado)) {
	$pdf->Cell($w[0],5,substr(mysql_result($res_resultado,$contador,"nombre"), 0, 30),'LRTB',0,'L');
	$pdf->Cell($w[1],5,mysql_result($res_resultado,$contador,"nif"),'LRTB',0,'C');
	$pdf->Cell($w[2],5,substr(mysql_result($res_resultado,$contador,"direccion"),0,40),'LRTB',0,'L');
