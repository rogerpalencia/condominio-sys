 ...
 * Libreria de Fechas
 *
 * @autor cooperativa soluciones en mano
 * @package libreria
 */
	...
	/**
	 * Convierte las horas del formato de 24 horas a 12 horas
	 * @param string $hora Hora a convertir
	 * @return string
	 */
	...
	/**
	 * Convierte las horas del formato de 12 horas a 24 horas
	 * @param string $hora Hora a convertir
	 * @return string
	 */
	...
	/**
	 * Retorna la fecha actual en un formato especifico
	 * @param string $pValor F => solo fecha | FH => fecha y hora
	 * @return string
	 */
	function FechaSis($pValor){
		...
		switch (strtoupper($pValor)) {
			...
			case "FH":
				...
				break;
			default:
				return('función FechaSis: parametro no válido');
				break;
		}
	}
	...
	/**
	 * Retorna la fecha actual en un formato largo
	 * @return string
	 */
	function FechaLarga() {
	...
	/**
	 * Retorna la fecha que se le pase como parametro en un formato largo : dd de NombreMes  yyyy
	 * @return string
	 */
	...
	/**
	 * Retorna la hora actual en un formato largo
	 * @return string
	 */
	function HoraLarga() {
			$Hora = date("g");
	...
	/**
	 * Convierte una fecha en un formato especifico
	 * @param string $accion M => retorna un valor en formato DD/MM/YYYY | G => devuelve la fecha en formato Y-m-d en mktime() con hora;
	 * @param string $pSeparador Caracter de separacion de las fechas
	 * @param string $pFecha Fecha a convertir
	 * @return string
	 */
	 ...
	 * @param string $fecha_actual Fecha inicial
	 ...
	 * @param string $interval formato de sustraccion
	 * @param string $datefrom Fecha inicial
	 * @param string $dateto Fecha final
	 * @param string $using_timestamps si utiliza timestamp
	 * @return string
	 */
