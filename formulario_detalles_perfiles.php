                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <h4 class="mb-sm-0 font-size-18">Gestión de Perfil de Usuario</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-title-desc"><button type="button" class="btn btn-success waves-effect waves-light w-sm" onclick="ndeclaracionaduana()" title="Agregar Item">Nuevo Perfil</button></p>
                            </div>
                            <div class="card-body">
        ...
        $('#mytable').DataTable({
            "columnDefs": [{
                ...
                },
                {
                    ...
                    data: 'id_perfil',
                    "render": function(data, type, row, meta) {
                        return '<button type="button" onclick="delete(' + data + ')" class="btn btn-primary btn-sm waves-effect waves-light" title="Eliminar Perfil"><i class="fas fa-edit font-size-8"></i></button>';
                    },
                    "searchable": false
                }
            ],
